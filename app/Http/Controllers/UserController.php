...
//        }
    ...
    public function create_event(Request $request) {
        $user = $request->user();
        $datetime_start = new \DateTime::date_create_from_format("Y-m-d H:i:s", $request->start());
        $datetime_end = new \DateTime::date_create_from_format("Y-m-d H:i:s", $request->end());
